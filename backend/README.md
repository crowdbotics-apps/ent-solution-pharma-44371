...
## Project Structure
    ...
    ├── pharmacy_lite_templ_44371  # Django project configurations
...
1. Clone this repo and `cd pharmacy_lite_templ_44371`
...
2. Clone this repo and `cd pharmacy_lite_templ_44371`
